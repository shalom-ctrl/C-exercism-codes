...
{
    public static string AnalyzeOnField(int shirtNumber)
    {
        switch (shirtNumber)
        {
    ...
    public static string AnalyzeOffField(object report)
    {
        switch (report)
        {
            ...
            case Injury injury:
                // injury.GetDescription() returns "Player 3 is injured."
                // So we just need to wrap it with "Oh no! " and the Medics part.
